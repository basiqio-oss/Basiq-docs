...
> 📘 Enrich URL is → [https://au-api.basiq.io/enrich](https://au-api.basiq.io/enrich) - contact us to have your API key activated to try out this API.

> 📘 Affordability URL is → [https://au-api.basiq.io/affordability](https://au-api.basiq.io/affordability) - you can use our sandbox environment for free - contact us to have your API key activated.

## How does the API work?

![1743](https://files.readme.io/50c7b9e-Group_2680.png "Group 2680.png")
