...
## ❌  We don't provide event notifications (...yet)

*Watch this space...* Although we do not currently do not offer any Webhook style support, we are currently working on an action initiation feature, which will enable you to subscribe to changes in data.
