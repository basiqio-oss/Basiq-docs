...
excerpt: >-
  A comprehensive list of each error code you could encounter when hitting each
  endpoint, and what to do when that happens.
deprecated: false
hidden: false
metadata:
  title: ''
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        You currently only have a sandbox account and need to be enabled for live data beore you can connect real institutions. Please contact Customer Support to do so.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        `The institution you are trying to connect to is currently disabled. Our developers have been notified and are working to have the issue resolved. You can check the state each institution via the /institutions/:id api.`
      </td>

      <td>
        We are having issues with this institutions and are working on it. You can check the status of it using the status page on your dashboard or by calling the 
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `Supplied Institution ID is not valid`
      </td>

      <td>
        provide  valid institutionId in URL
      </td>
    </tr>
