...
metadata:
  ...
  robots: noindex
next:
  description: Get a breakdown of all the error codes that can be returned
  pages:
    - type: basic
      slug: error-codes-1
      title: Error codes
...
[block:parameters]
{
  "data": {
    ...
    "2-1": "an application-specific [error code](https://api.basiq.io/docs/errors-1), expressed as a string value.",
