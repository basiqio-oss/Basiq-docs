...
next:
  description: ''
---
<Image width="80%" src="https://files.readme.io/d89e07a-customiseUi.gif" />

 

Partners are able to setup and configure their applications via the `customise-ui` tab in the [basiq dashboard](https://dashboard.basiq.io). Partners will also be able to see a live preview of the [Consent UI](ref:consent-ui) while they make these changes. 
...
<Image width="80%" src="https://files.readme.io/bec0ea4-Screen_Shot_2022-08-24_at_1.17.35_pm.png" />
...
<Image width="80%" src="https://files.readme.io/cc2b27e-Screen_Shot_2022-08-31_at_10.07.10_am.png" />
...
![2738](https://files.readme.io/12cdc15-ConsentUI-HeaderImage.png "ConsentUI-HeaderImage.png")
