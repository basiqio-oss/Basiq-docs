...
In order to gain access to the API, you need to pass the appropriate version in HTTP header basiq-version, when [exchanging](https://api.basiq.io/docs/authentication-1) your API key for a token. 
