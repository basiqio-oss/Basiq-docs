...
next:
  ...
  pages:
    - type: link
      ...
      url: https://api.basiq.io/v2.1/docs/basiq-api-services-1
---
[block:api-header]
{
  "title": "What is Basiq?"
...
* **Connect**: Access *user consented*, account and transaction data in real-time

* **Enrich**: Enhance transactions with merchant data

* **Discover**: Gain deeper insights of your customer's finances

* **Automate**: Insight-driven automation [coming soon]
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/274ea20-connect_retina.png",
        "connect_retina.png",
        1200,
        800,
        "#64968f"
