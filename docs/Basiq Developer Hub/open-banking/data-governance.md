...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        When **the user**explicitly revokes the consent.
      </td>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        * \*The user\*\* has made a change to their consent.
      </td>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        When a consent object has been created for a specific **user**.
      </td>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        When **the partner** archives the consent.
      </td>
