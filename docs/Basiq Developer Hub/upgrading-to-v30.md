...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1a93039-openbankingcomponents_1.svg",
        "openbankingcomponents (1).svg",
        1098,
        739,
        "#e2e8ea"
      ],
...
{
  "type": "info",
  "title": "Upgrading to v3.0 does not automatically enable you for Open Banking data access",
  "body": "Partners are able to upgrade to access v3.0 of the API without being enabled for Open Banking. If you would like to be enabled for Open Banking please reach out to support@basiq.io where the team can assist in registering your application."
}
[/block]
## Migrating to 3.0
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f398f3c-Customise_UI.png",
        "Customise UI.png",
        1880,
        1122,
        "#dee3e8"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/672076b-ConsentUI-HeaderImage.png",
...
[block:parameters]
{
  "data": {
    "h-0": "New fields",
    "0-0": "Header Image",
    "0-1": "Your products brand image that will be presented to the end user when they view the Consent UI",
    "1-0": "Redirection URL",
    "1-1": "The URL you would like your users to be redirected to on completing their bank connections"
  },
  "cols": 2,
  "rows": 2
}
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/158e134-Screen_Shot_2022-09-02_at_3.31.18_pm.png",
        "Screen Shot 2022-09-02 at 3.31.18 pm.png",
        2728,
        1398,
        "#eaebf1"
      ]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a3aea15-Screen_Shot_2022-09-02_at_3.33.33_pm.png",
        "Screen Shot 2022-09-02 at 3.33.33 pm.png",
        2016,
        1464,
        "#ebedef"
      ]
