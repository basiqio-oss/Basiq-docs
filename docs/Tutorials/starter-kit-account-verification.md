...
<Image src="https://files.readme.io/2dcf482-DevHub_StarterKit_1080x800.png" align="center" width="auto" />
...
<Image src="https://files.readme.io/f9a1157-Group_2682.png" align="center" width="smart" />
...
<Table align={["left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Our starter kits are configurable to fit all brand guidelines, mainly by updating the `tailwind.config.js` with your brands colours and typeface. _Importing fonts can be done via_`styles.css`
      </td>
    </tr>
