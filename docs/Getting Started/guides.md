...
<Grid columns="3" gapX="30px" gapY="30px" paddingY="1.5em" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
  ...
  <CoolTile header="Basiq Demo App" href="https://demo.basiq.io" icon="fa-duotone fa-solid fa-display" badge="FEATURED" text="A one-stop demo app to explore Basiq’s APIs and end-to-end workflows." />
