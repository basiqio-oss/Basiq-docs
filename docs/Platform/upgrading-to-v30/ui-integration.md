...
<Image width="smart" src="https://files.readme.io/bbddefc-Group_2590_1.svg" />
...
![800](https://files.readme.io/ef31054-Frame_6.svg "Frame 6.svg")
...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        The Partner Legal entity name for CDR
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        The Accreditation Number the Partner will be using to access CDR data
      </td>
    </tr>
  </tbody>
</Table>
