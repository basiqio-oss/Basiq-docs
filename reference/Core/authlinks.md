...
{
  "type": "info",
  "title": "Generate a secure link by Creating an Auth Link resource",
  "body": "When a new Auth Link POST request is made, 2FA is activated against the link using the mobile phone number attached to the User object. It is important to ensure that this is a valid mobile number and belongs to the User/applicant as 2FA is via SMS."
}
[/block]