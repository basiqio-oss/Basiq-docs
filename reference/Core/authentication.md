...
{
  "type": "danger",
  "body": "Do not share your API keys in publicly accessible areas such GitHub, client-side code, etc.",
  "title": "Your API keys carry many privileges, so be sure to keep them secret!"
}
[/block]
