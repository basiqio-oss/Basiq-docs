...
<Grid columns="3" gapX="30px" gapY="30px" paddingY="1.5em" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
  ...
  <CoolTile header="Reporting" href="https://raw.githubusercontent.com/basiqio-oss/Basiq-docs/refs/heads/v3.0/reference/reports.json" icon="fa-duotone fa-file-chart-column" text="Generate and manage financial reports across supported report types." />
