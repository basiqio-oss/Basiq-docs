...
{
  "type": "info",
  "body": "Base URL is → https://au-api.basiq.io - you can use our sandbox environment for free right now - just grab an API key!"
}
[/block]
...
{
  "type": "info",
  "body": "Enrich URL is → https://au-api.basiq.io/enrich - contact us to have your API key activated to try out this API."
}
[/block]
...
{
  "type": "info",
  "body": "Affordability URL is → https://au-api.basiq.io/affordability - you can use our sandbox environment for free - contact us to have your API key activated."
}
[/block]