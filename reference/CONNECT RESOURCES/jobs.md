...
[block:parameters]
{
  "data": {
    ...
    "4-0": "**steps**\n*readonly*",
    "4-1": "List of steps that need to be completed. With the following properties:\n\n- **title** - Name of the step the job needs to complete.\n- **status** - Step status: `pending`, `in-progress`, `success`, `failed`.\n- **result** - List of URLs of the updated (or created) resources. Otherwise if a step `failed` contains an [error](https://basiq.readme.io/v1.0/reference#errors) response",
    "5-0": "**links**\n*readonly*",
    "5-1": "Links to the following resources:\n- **self** - URL of job resource\n- **source** - Resource that initiated creation of this Job. For example, for operations on [Connection](https://basiq.readme.io/v1.0/reference#connections), this is a Connection URL"
  },
  "cols": 2,
  "rows": 6
}
