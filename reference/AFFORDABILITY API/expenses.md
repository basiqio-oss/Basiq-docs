...
Returns a created expenses resource, if the operation succeeded. Returns an [error](https://basiq.readme.io/v2.0/reference#errors) if the post failed (e.g. not supplying required properties).
[block:code]
{
  "codes": [
    {
