...
next:
  description: ''
---
Use this collection to retrieve a list of [Affordability](https://basiq.readme.io/v2.1/reference/affordability) resources generated.  The list provides a short form on the affordability resource responses with a link to the full response.  The collection is ordered by generated date in descending order.
