...
Create a new statement by uploading an official pdf bank statement or csv file statement. When a new statement request is made, the server will [create a job](https://basiq.readme.io/v2.1/reference/jobs) that will process the following steps:
...
You can [check the status of each step](https://basiq.readme.io/v2.1/reference/retrieve-a-job) by querying the job resource (returned when the statement is created).
