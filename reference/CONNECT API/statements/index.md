...
>
> When a new Statement request is made, the server will [create a job](https://basiq.readme.io/v2.1/reference/jobs) that will processes 3 steps verify the file, retrieve accounts and transactions
