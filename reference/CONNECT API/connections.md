...
[block:parameters]
{
  "data": {
    ...
    "24-1": "The institution the connection relates to.",
    "26-1": "User's accounts in this institution.",
    "28-1": "A links object containing the following members:",
    "18-0": "`lastUsed`",
    "24-0": "[**institution**](https://api.basiq.io/reference/institutions)",
    "26-0": "**[accounts](https://api.basiq.io/reference/accounts)**",
    "28-0": "**links**",
    ...
    "30-1": "- `self` link to the requested connection\n\n- `accounts` link to the accounts associated with this connection\n- `transactions` link to the transactions associated with this connection",
    "20-0": "`profile`",
    "20-1": "Available profile data for the logged in user or data sharer.  Where no data is available the attribute is \"null\". This attribute contains the following properties and will return \"null\" for data that is unavailable:",
