  ...
  <tbody>
    <tr>
      <td style={{ textAlign: "left" }}>
        **[filter](https://basiq.readme.io/v2.1/reference/accounts)**
        *string, optional*
      </td>

      <td style={{ textAlign: "left" }}>
        This list can be [filtered](https://basiq.readme.io/v2.1/reference/filters) by the following properties:
