...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        The id of the [institution](https://basiq.readme.io/v2.1/reference/institutions) resource the account originated from.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        The **latest** id of the [connection](https://basiq.readme.io/v2.1/reference/connections) resource that was used to retrieve the account.
      </td>
    </tr>
