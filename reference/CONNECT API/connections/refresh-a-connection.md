...
[/block]
You can [check the status of each step](https://api.basiq.io/v2.1/reference/retrieve-a-job) by querying the job resource (returned when the connection is created).
[block:parameters]
{
  "data": {
    "h-0": "Arguments",
