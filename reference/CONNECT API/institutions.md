...
[block:parameters]
{
  "data": {
    ...
    "6-0": "`transactions`",
    "8-1": "- `description`\n      \n- `date`\n\n- `amount`\n      \n- `balance`\n\n- `class`",
    "6-1": "Describes the support of [Transactions](ref:transactions) attributes by institution for each data source",
    "10-0": "`profile`",
    "12-1": "- `firstName`\n\n- `lastName`\n\n- `middleName`\n\n- `emailAddresses`\n\n- `physicalAddresses`",
    "10-1": "Describes the support of [Connection with profile data](ref:retrieve-a-connection)  attributes by institution for each data source",
    "2-0": "`accounts`",
    "2-1": "Describes the support of [Accounts](ref:accounts)  attributes by institution for each data source"
  },
  "cols": 2,
  "rows": 14
}
