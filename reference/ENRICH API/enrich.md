...
[block:parameters]
{
  "data": {
    ...
    "0-0": "`Merchant`",
    "1-0": "`Location`",
    "0-1": "Details relating to the store or merchant such as business name, website and contact details",
...
[block:parameters]
{
  "data": {
    "h-0": "Merchant",
    "6-0": "`website`",
    "6-1": "The merchant website.",
    "8-0": "`phoneNumber`",
    "8-1": "Provides the `local` and `international` telephone numbers of the merchant.",
    "0-0": "`id`",
    "0-1": "The merchant id.",
    "2-0": "`businessName`",
    "2-1": "The merchant business name.",
    "4-0": "`ABN`",
    "4-1": "The merchant business ABN."
  },
  "cols": 2,
  "rows": 10
}
